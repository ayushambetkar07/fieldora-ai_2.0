...
import { calculateQuantityScore } from '../utils/unitConversion.js';
 ...
 */
export function calculateVarietyScore(rfqVariety, listingVariety) {
 ...
 */
export function calculateMatch(rfq, listing) {
    ...
    const rawPercentage = (cropScore * MATCH_WEIGHTS.CROP +
 ...
 */
export async function findMatchesForRfq(rfqId) {
    // 1. Fetch the RFQ
