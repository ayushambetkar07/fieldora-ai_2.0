 ...
 */
export function calculateDistanceKm(farmerLoc, buyerLoc) {
    const fLower = (farmerLoc || '').toLowerCase().trim();
    const bLower = (buyerLoc || '').toLowerCase().trim();
    // 1. Established Key Agri-Transport Corridors
    if (fLower === bLower)
        return 15;
    if ((fLower.includes('nashik') && bLower.includes('mumbai')) || (fLower.includes('mumbai') && bLower.includes('nashik')))
        return 165;
    if ((fLower.includes('lasalgaon') && bLower.includes('mumbai')) || (fLower.includes('mumbai') && bLower.includes('lasalgaon')))
        return 195;
    if ((fLower.includes('pimpalgaon') && bLower.includes('mumbai')) || (fLower.includes('mumbai') && bLower.includes('pimpalgaon')))
        return 185;
    if ((fLower.includes('sinnar') && bLower.includes('mumbai')) || (fLower.includes('mumbai') && bLower.includes('sinnar')))
        return 150;
    if ((fLower.includes('pune') && bLower.includes('mumbai')) || (fLower.includes('mumbai') && bLower.includes('pune')))
        return 148;
    if ((fLower.includes('nashik') && bLower.includes('pune')) || (fLower.includes('pune') && bLower.includes('nashik')))
        return 210;
    if ((fLower.includes('indore') && bLower.includes('mumbai')) || (fLower.includes('mumbai') && bLower.includes('indore')))
        return 585;
