...
CREATE TABLE IF NOT EXISTS orders (
  ...
  status VARCHAR NOT NULL DEFAULT 'Confirmed' CHECK (status IN ('Confirmed', 'Transport Confirmed', 'Escrow Locked', 'In Transit', 'Arrived', 'Delivered', 'Quality Verified', 'Completed', 'Cancelled', 'Disputed')),
  ...
  transport_confirmed_by VARCHAR,
  ...
  actual_received_quantity NUMERIC,
  actual_quantity_unit VARCHAR DEFAULT 'kg',
  quality_grade VARCHAR,
  assay_result VARCHAR,
  assay_notes TEXT,
