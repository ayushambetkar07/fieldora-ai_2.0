 ...
 */
router.get('/trust-score/:userId', async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
const handleUserReviews = async (req: AuthRequest, res: Response) => {
  try {
    const userId = String(req.params.userId || '');
 ...
 */
router.patch('/:reviewId', requireAuth, async (req: AuthRequest, res: Response) => {
  try {
    const userId = getAuthUserId(req);
 ...
 */
router.delete('/:reviewId', requireAuth, async (req: AuthRequest, res: Response) => {
  try {
    const userId = getAuthUserId(req);
    const reviewId = String(req.params.reviewId || '');
